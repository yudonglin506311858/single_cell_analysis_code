...
setwd("D:/analysis/forpublication/nonpro1")
setwd("./14cluster")
saveRDS(YDL,"14cluster_nonpro1_singlet.RDS")
YDL<-readRDS("14cluster_nonpro1_singlet.RDS")
...
head(new)
write.table(new,"Cell.Info.txt")

head(new)
colnames(new)<-c("Cell Type","Cluster")
write.csv(new,"CellType.Info.txt")



cell.info <- read.table("Cell.Info.txt", header = T, row.names = 1)
...
dim(regulonAUC)
write.table(regulonAUC,"AUCell.txt")#更改括号
cell.info <- readRDS("cell.info.rds")
...
head(binaryRegulonActivity[1:4,1:4])
write.table(binaryRegulonActivity,"binary_mtx.txt")#修改（）
...
write.csv(data,"cell_0.csv")
PlotRegulonRank(rssMat, "cell_0",topn=10)
PlotRegulonRank(rssMat, "cell_0",topn=5)
...
write.csv(data,"cell_1.csv")
PlotRegulonRank(rssMat, "cell_1",topn=10)
PlotRegulonRank(rssMat, "cell_1",topn=5)
...
write.csv(data,"cell_2.csv")
PlotRegulonRank(rssMat, "cell_2",topn=10)
PlotRegulonRank(rssMat, "cell_2",topn=5)
...
write.csv(data,"cell_3.csv")
PlotRegulonRank(rssMat, "cell_3",topn=10)
PlotRegulonRank(rssMat, "cell_3",topn=5)
...
write.csv(data,"cell_4.csv")
PlotRegulonRank(rssMat, "cell_4",topn=10)
PlotRegulonRank(rssMat, "cell_4",topn=5)
...
write.csv(data,"cell_5.csv")
PlotRegulonRank(rssMat, "cell_5",topn=10)
PlotRegulonRank(rssMat, "cell_5",topn=5)
...
write.csv(data,"cell_6.csv")
PlotRegulonRank(rssMat, "cell_6",topn=10)
PlotRegulonRank(rssMat, "cell_6",topn=5)
...
write.csv(data,"cell_7.csv")
PlotRegulonRank(rssMat, "cell_7",topn=10)
PlotRegulonRank(rssMat, "cell_7",topn=5)
...
write.csv(data,"cell_8.csv")
PlotRegulonRank(rssMat, "cell_8",topn=10)
PlotRegulonRank(rssMat, "cell_8",topn=5)
...
write.csv(data,"cell_9.csv")
PlotRegulonRank(rssMat, "cell_9",topn=10)
PlotRegulonRank(rssMat, "cell_9",topn=5)
...
write.csv(data,"cell_10.csv")
PlotRegulonRank(rssMat, "cell_10",topn=10)
PlotRegulonRank(rssMat, "cell_10",topn=5)
...
write.csv(data,"cell_11.csv")
PlotRegulonRank(rssMat, "cell_11",topn=10)
PlotRegulonRank(rssMat, "cell_11",topn=5)
...
write.csv(data,"cell_12.csv")
PlotRegulonRank(rssMat, "cell_12",topn=10)
PlotRegulonRank(rssMat, "cell_12",topn=5)
...
write.csv(data,"cell_13.csv")
PlotRegulonRank(rssMat, "cell_13",topn=10)
PlotRegulonRank(rssMat, "cell_13",topn=5)
...
DimPlot(cell.info, regulon = "Pou2af1_extended_36g")
DimPlot(cell.info, cell.type = "cell_10")
...
figPlot(cell.type = "cell_10",regulon = "Pou2af1_extended_36g")
...
CellType.info <- read.table("CellType.Info.txt", sep = "\t", header = T)
