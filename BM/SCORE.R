...
pdf("Erythroblasts_打分.pdf")
nonpro<-Erythroblasts
...
colnames(nonpro@meta.data)[6] <- 'pro_score' 
...
head(nonpro@meta.data)
colnames(nonpro@meta.data)[7] <- 'baso_score' 
...
head(nonpro@meta.data)
colnames(nonpro@meta.data)[8] <- 'ortho_score' 
...
head(nonpro@meta.data)
colnames(nonpro@meta.data)[9] <- 'poly_score' 
